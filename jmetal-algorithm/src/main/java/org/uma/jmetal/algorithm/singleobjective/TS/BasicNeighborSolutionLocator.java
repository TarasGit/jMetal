...
public class BasicNeighborSolutionLocator implements BestNeighborSolutionLocator { 
 ...
 @Override 
 public Optional<PermutationSolution<Integer>> findBestNeighbor(List<PermutationSolution<Integer>> neighborsSolutions, final List<PermutationSolution<Integer>> solutionsInTabu) { 
