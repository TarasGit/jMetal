...
public class AntColonyOptimizationRunnerNRPRealistic {
	...
	public static final double 	Q = 1000;// feramon deposited level, 0<=x<=1
...
//	public static final double RHO = 0.2;//feramon avapouration level, 0<=x<=1
	...
	public static void main(String[] args) throws Exception {
		...
		problem = new NRPRealistic("/nrpRealisticInstances/nrp-e2.txt", COST_FACTOR);// 500(Min costs)//new
