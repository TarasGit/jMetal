...
public class NRPRealistic extends AbstractBinaryIntegerPermutationProblem implements BudgetProblem {
	 ...
	 */
	public NRPRealistic(String distanceFile, double costFactor) throws IOException {
