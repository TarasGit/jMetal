...
import org.uma.jmetal.util.comparator.MyDominanceComparator;
...
public class MyNonDominatedSolutionListArchive<S extends Solution<?>> implements Archive<S> {
   ...
   * Constructor
   */
  public MyNonDominatedSolutionListArchive() {
    this(new MyDominanceComparator<S>());
  }

  /**
   * Constructor
   */
  public MyNonDominatedSolutionListArchive(MyDominanceComparator<S> myDominanceComparator) {
  ...
  public static void main(String args[]) {
    ...
    Archive<DoubleSolution> archive = new MyNonDominatedSolutionListArchive<>() ;
