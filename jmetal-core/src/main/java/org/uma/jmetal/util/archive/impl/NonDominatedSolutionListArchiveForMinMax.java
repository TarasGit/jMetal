...
import org.uma.jmetal.util.comparator.DominanceComparatorForMinMax;
import org.uma.jmetal.util.comparator.MyEqualSolutionsComparator;
import org.uma.jmetal.util.pseudorandom.JMetalRandom;

/**
 * This class implements an archive containing non-dominated solutions
 *
 * @author changed for Max(Profit)/Min(Costs) Problem by Taras
 *         Iks<ikstaras@gmail.com>
 */
@SuppressWarnings("serial")
public class NonDominatedSolutionListArchiveForMinMax<S extends Solution<?>> implements Archive<S> {
	private List<S> solutionList;
	private Comparator<S> dominanceComparator;
	private Comparator<S> equalSolutions = new MyEqualSolutionsComparator<S>();

	/**
	 * Constructor
	 */
	public NonDominatedSolutionListArchiveForMinMax() {
		this(new DominanceComparatorForMinMax<S>());
	}

	/**
	 * Constructor
	 */
	public NonDominatedSolutionListArchiveForMinMax(DominanceComparatorForMinMax<S> myDominanceComparator) {
		dominanceComparator = myDominanceComparator;
	...
	public static void main(String args[]) {
		...
		Archive<DoubleSolution> archive = new NonDominatedSolutionListArchiveForMinMax<>();
