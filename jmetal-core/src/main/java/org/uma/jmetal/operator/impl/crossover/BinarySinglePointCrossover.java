...
public class BinarySinglePointCrossover implements CrossoverOperator<PermutationSolution<Integer>> {
	...
	/** Constructor */
	public BinarySinglePointCrossover(double crossoverProbability, RandomGenerator<Double> crossoverRandomGenerator,
	 ...
	 */
	public List<PermutationSolution<Integer>> doCrossover(double probability, PermutationSolution<Integer> parent1,
			PermutationSolution<Integer> parent2) {//TODO: Check it.
		...
		if (crossoverRandomGenerator.getRandomValue() <= probability) {
			...
			for (int i = crossoverPoint; i < totalNumberOfBits; i++) {// TODO: check it.
